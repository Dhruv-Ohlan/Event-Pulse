            ...
            <form className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-[#e7ddff] bg-white px-4 py-3 text-sm text-[#2e1065] outline-none transition focus:border-[#8b5cf6] focus:ring-4 focus:ring-[#8b5cf6]/15"
                />
              </div>
              <div>
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 text-[#6b5b8c]">
                  <input type="checkbox" className="h-4 w-4 rounded border-[#c4b5fd] text-[#7c3aed] focus:ring-[#8b5cf6]" />
                  Remember me
                </label>
